...
##########################  
  # 1 - download data and read from xls (originally downloaded from CBO, then stored in dataverse for stability)
    if ( !("forec_in2013.xls" %in% dir()) ) {
  ...
  # 2 - extract relevant cols and rows
  ...
  trends.df <- trends.df[c(sel.row1, sel.row2, sel.row3) , sel.col]
  ...
  # 4 - compute compounded growth rates over multiple years
