...
list.of.packages <- c("knitr","foreign", "dplyr", "weights", "survey", "Hmisc", 
                      ...
                      "reshape2", "tidyr", "xtable", "haven", "here")
...
To describe the methodology behind each of those four components we first describe the data used, the chosen wage variable, and the procedure used to forecast the wage and population distribution of 2016 using data from 2013.  
...
call.cps.org.data <- function(){
  ...
  # Checking if working directory contains data, download if not. 
    ...
    df <- haven::read_dta("cepr_org_2013.dta")
  }
...
Additional information needed from CBO: $\alpha$ and $G$.    
...
if ( !("minwage" %in% dir()) ) {
  ...
  min.wage.data <- cbind(aux.1[[1]], aux.1[[2]][,-1], 
                         aux.1[[3]][,-1], aux.1[[4]][,-1], 
                         aux.1[[5]][1:55,-1])
  min.wage.data <- min.wage.data[, - (32:38)]
