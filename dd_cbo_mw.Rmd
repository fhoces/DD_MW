...
CBO mentions that "it found far fewer workers who would be directly affected by the change in the minimum wage than it had in its analysis of employment", using the CPS ASEC we get `r paste(round(table_8[ "% < 10.10",2]*100, 1), "%", sep="")` workers below the 10.10 threshold in 2016, while using the CPS ORG we get`r paste(round(table_4[ "% < 10.10",2]*100, 1), "%", sep="")` in 2016. Given that the differences are not so large, we do not perfomer this adjustment.
